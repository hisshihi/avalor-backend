...
public interface RouteRailwayRepository extends JpaRepository<RouteRailway, Long> {
    RouteRailway findByPolAndPodAndFilo20AndFilo20HCAndFilo40AndCarrier(String pol, String pod, Integer filo20, Integer filo20HC, Integer filo40, String carrier);
