...
public class RouteDto {
    ...
    private List<DropOffEntity> dropOffEntity;
//    private List<DropOffEntity> dropOff;
    private List<Long> railways;
    private List<Long> seas;
    private List<Long> autos;

    public RouteDto(List<RouteSegmentDto> segments, int totalCost, RentEntity rent, List<DropOffEntity> dropOffEntity, List<Long> railways, List<Long> seas, List<Long> autos) {
